...
def tqdmnd(*args, **kwargs):
    ...
    with a tqdm progress bar printed to standard output.
    ...
    Accepts:
        *args: Any number of integers or iterators. Each integer N
            ...
            i.e. `for x,y in tqdmnd(2,3)` will return (0,0), (0,1),
            (0,2), (1,0), (1,1), (1,2).
    ...
    Returns:
        ...
        values of each input iterator (in the same order as the inputs) over
